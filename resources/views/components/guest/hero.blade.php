    ...
    <section class="py-60 md:py-86 bg-gray-950 relative overflow-hidden text-center">
        <div class="container mx-auto px-6 z-10 relative">
            ...
            <p class="mt-4 text-xl text-gray-400 max-w-2xl mx-auto">
                Manage your money in a way that aligns with your values. Our platform is built on transparency,
                integrity, and ethical principles.
            </p>
            <!-- Buttons are always side-by-side on all screen sizes -->
            @guest
                <div class="mt-8 flex justify-center space-x-4">
                    <a x-data="{}" @click="$dispatch('open-login')"
                    ...
                    <a x-data="{}" @click="$dispatch('open-register')"
